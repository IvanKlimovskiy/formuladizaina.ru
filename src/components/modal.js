import {buttonsClosePopup, formOpenedPopup, popupList, smallMenuOverlay, smallNavMenu} from "./variables";
...
popupList.forEach((popup) => {
  popup.addEventListener("click", (evt) => {
    if (evt.target.classList.contains("popup") || evt.target.classList.contains("nav-menu-small__overlay")) {
      closePopup(popup);
    }
  })
})
